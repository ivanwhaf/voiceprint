...
parser.add_argument('-project_name', type=str, help='project name', default='voiceprint_aishell1_ecapatdnn')
parser.add_argument('-noise_type', type=str, help='noise type', default='asymmetric')
parser.add_argument('-noise_rate', type=float, help='noise rate', default=0.05)
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = create_dataloader(args.dataset_path)
